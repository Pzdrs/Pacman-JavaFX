...
public class Events {
    ...
    public Events(Pacman pacman, Stage stage, Game game) {
        ...
        acceptedInput.add(KeyCode.UP);
        acceptedInput.add(KeyCode.W);
        acceptedInput.add(KeyCode.DOWN);
        acceptedInput.add(KeyCode.S);
        acceptedInput.add(KeyCode.LEFT);
        acceptedInput.add(KeyCode.A);
        acceptedInput.add(KeyCode.RIGHT);
        acceptedInput.add(KeyCode.D);
        acceptedInput.add(KeyCode.R);
        acceptedInput.add(KeyCode.F3);
        acceptedInput.add(KeyCode.F4);
